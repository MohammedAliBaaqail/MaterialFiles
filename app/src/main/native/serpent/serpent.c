...
/*#define LE32(x) mirror_bytes32(x)
...
#define SERPENT_MINIMIZE_CODE_SIZE 1
#define LE32(x) (x)
...
#ifdef SERPENT_MINIMIZE_CODE_SIZE
...
#endif // SERPENT_MINIMIZE_CODE_SIZE
#ifndef SERPENT_MINIMIZE_CODE_SIZE
...
#else // SERPENT_MINIMIZE_CODE_SIZE
...
#endif // SERPENT_MINIMIZE_CODE_SIZE
#if !defined (SERPENT_MINIMIZE_CODE_SIZE) || defined (TC_WINDOWS_BOOT_SERPENT)
...
#else // SERPENT_MINIMIZE_CODE_SIZE && !TC_WINDOWS_BOOT_SERPENT
...
#endif // SERPENT_MINIMIZE_CODE_SIZE && !TC_WINDOWS_BOOT_SERPENT
