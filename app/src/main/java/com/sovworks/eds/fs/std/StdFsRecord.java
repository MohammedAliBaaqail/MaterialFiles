...
public abstract class StdFsRecord implements FSRecord {
    ...
    public void rename(String newName) throws IOException {
        StringPathUtil pathUtil = _path.getPathUtil();
        StringPathUtil newPath = pathUtil.getParentPath().combine(newName);
        moveTo((StdFsPath) _path.getFileSystem().getPath(newPath.toString()));
    }
